...
public class RepositoryDetailFragment extends Fragment {
    ...
    private void updateView(String repositoryName, int id) {
        ...
        ImageView repoAvatar = (ImageView) getActivity().findViewById(R.id.repoAvatar);
        ...
        TextView repoName = (TextView) getActivity().findViewById(R.id.repoName);
        repoName.setText(details.repositoryName);

        TextView stargazersCount = (TextView) getActivity().findViewById(R.id.stars);
        ...
        TextView createdDate = (TextView) getActivity().findViewById(R.id.createdDate);
        createdDate.setText(dateFormat.format(details.createdDate));

        TextView repositoryLanguage = (TextView) getActivity().findViewById(R.id.repositoryLanguage);
        repositoryLanguage.setText(details.language);

        TextView ownerLogin = (TextView) getActivity().findViewById(R.id.ownerLogin);
        ownerLogin.setText(details.owner.login);

        TextView ownerUrl = (TextView) getActivity().findViewById(R.id.ownerUrl);
